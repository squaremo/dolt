...
Lexeme
  = kw:ReservedWord { return {type:'reserved', chars:kw[0]}; }
  / ws:WS { return {type: 'ws', chars:ws}; }
  / c:Comment { return {type:'comment', chars:c}; }
  / id:Identifier { return {type:'identifier', chars:id}; }
  / v:Literal { return {type:'literal', chars:v } }
  / p:Punctuation { return {type:'punctuation', chars:p}; }
  / op:Operator { return {type:'operator', chars:op}; }

WS
  = parts:(WhiteSpace / LineTerminatorSequence)+ {
      return parts.join('');
    }
...
/*
* ff are from JavaScript example distributed with
* PEG.js
*/
...
/* ff 2 modified to return chars only*/
...
/* %%% These modified to just return the characters */
